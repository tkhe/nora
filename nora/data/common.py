...
from nora.utils.serialize import PicklableWrapper
...
class _TorchSerializedList:
    ...
    def __init__(self, lst: list):
        ...
        logger.info(f"Serializing {len(self._lst)} elements to byte tensors and concatenating them all ...")
        ...
        logger.info(f"Serialized dataset takes {len(self._lst) / (1024 ** 2):.2f} MiB")
