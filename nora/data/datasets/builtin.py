...
from .ade20k import register_ade20k_sem_seg
...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "coco_2017_train_panoptic": (
        ...
        # You can use the script at nora/datasets/prepare_panoptic_fpn.py
...
_PREDEFINED_SPLITS_LVIS = {
    "lvis_v1": {
        ...
        "lvis_v1_test_dev": (
            "coco/",
            "lvis/lvis_v1_image_info_test_dev.json",
        ),
...
def register_all_ade20k(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        gt_dir = os.path.join(root, "annotations_nora", dirname)
        name = f"ade20k_sem_seg_{name}"
        register_ade20k_sem_seg(name, image_dir, gt_dir)


if __name__.endswith(".builtin"):
    # Assume pre-defined datasets live in `./datasets`.
    _root = os.path.expanduser(os.getenv("NORA_DATASETS", "datasets"))
