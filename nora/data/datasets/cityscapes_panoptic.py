...
def get_cityscapes_panoptic_files(image_dir, gt_dir, json_info):
    ...
    for ann in json_info["annotations"]:
        ...
        assert image_file is not None, f"No image {ann['image_id']} found for annotation {ann['file_name']}"
...
def load_cityscapes_panoptic(image_dir, gt_dir, gt_json, meta):
    ...
    Returns:
        list[dict]: a list of dicts in nora standard format.
    """
    ...
    assert os.path.exists(gt_json), "Please run `python cityscapesscripts/preparation/createPanopticImgs.py` to generate label files."
    ...
    assert PathManager.isfile(ret[0]["sem_seg_file_name"]), "Please generate labelTrainIds.png with cityscapesscripts/preparation/createTrainIdLabelImgs.py"
    assert PathManager.isfile(ret[0]["pan_seg_file_name"]), "Please generate panoptic annotation with python cityscapesscripts/preparation/createPanopticImgs.py"
...
def register_all_cityscapes_panoptic(root):
    ...
    # visualization function in nora handles thing and class classes differently
