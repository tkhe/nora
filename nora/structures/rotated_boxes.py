...
from nora.ops.box_iou_rotated import pairwise_iou_rotated as _pairwise_iou_rotated
...
class RotatedBoxes(Boxes):
    ...
    def __getitem__(self, item) -> "RotatedBoxes":
        ...
        b = self.tensor[item]
        assert b.dim() == 2, f"Indexing on RotatedBoxes with {item} failed to return a matrix!"
...
def pairwise_iou_rotated(boxes1: RotatedBoxes, boxes2: RotatedBoxes):
    """
    ...
    return _pairwise_iou_rotated(boxes1.tensor, boxes2.tensor)
