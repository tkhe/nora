...
NORA_LOG_BUFFER_SIZE_KEY: str = "NORA_LOG_BUFFER_SIZE"
...
def setup_logger(
    ...
    *,
    ...
    """
    Initialize the nora logger and set its verbosity level to "DEBUG".
    ...
    Args:
        ...
        abbrev_name (str): an abbreviation of the module, to avoid long names in logs.
            ...
            By default, will abbreviate "nora" to "N" and leave other
            modules unchanged.
    ...
    if abbrev_name is None:
        abbrev_name = "N" if name == "nora" else name
...
def _get_log_stream_buffer_size(filename: str) -> int:
    ...
    if NORA_LOG_BUFFER_SIZE_KEY in os.environ:
        return int(os.environ[NORA_LOG_BUFFER_SIZE_KEY])
...
def _find_caller() -> Tuple[str, Tuple[str, Union[int, Any], str]]:
    """
    Returns:
...
def log_first_n(
    ...
    *,
    ...
    key: Union[str, Tuple[str, str]] = "caller",
):
    """
