...
_MISSING_LOCAL_PG_ERROR = (
    "Local process group is not yet created! Please use nora's `launch()` "
...
@functools.lru_cache()
def create_local_process_group(num_workers_per_machine: int):
    """
    Create a process group that contains ranks within the same machine.

    nora's launch() in engine/launch.py will call this function. If you start
