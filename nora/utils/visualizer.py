...
class VisImage(object):
    def __init__(self, image, scale=1.0):
        """
        Args:
            image (ndarray): an RGB image of shape (H, W, 3) in range [0, 255].
    ...
    def reset_image(self, image):
        ...
        self.ax.imshow(image, extent=(0, self.width, self.height, 0), interpolation="nearest")
...
class Visualizer(object):
    ...
    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE, font_size_scale=1.0):
        ...
        self._default_font_size = max(np.sqrt(self.output.height * self.output.width) // 90, 10 // scale) * font_size_scale
    ...
    def draw_dataset_dict(self, dic):
        """
        Draw annotations/segmentations in nora dataset format.

        Args:
            dic (dict): annotation/segmentation data of one image, in nora dataset format.
    ...
    def overlay_instances(
        ...
        Args:
            ...
            masks (masks-like object): Supported types are:
                ...
                * :class:`nora.structures.PolygonMasks`,
                  :class:`nora.structures.BitMasks`.
