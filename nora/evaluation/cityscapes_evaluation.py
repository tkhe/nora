...
class CityscapesEvaluator(DatasetEvaluator):
    ...
    def reset(self):
        ...
        assert comm.get_local_size() == comm.get_world_size(), "CityscapesEvaluator currently do not work with multiple machines."
...
class CityscapesInstanceEvaluator(CityscapesEvaluator):
            ...
            if "instances" in output:
                ...
                with open(pred_txt, "w") as fout:
                    for i in range(num_instances):
                        ...
                        png_filename = os.path.join(self._temp_dir, basename + f"_{i}_{classes}.png")
    ...
    def evaluate(self):
        ...
        assert len(groundTruthImgList), f"Cannot find any ground truth images to use for evaluation. Searched for: {cityscapes_eval.args.groundTruthSearch}"
