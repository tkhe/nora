...
from nora.data.datasets.coco import convert_to_coco_json
...
from nora.utils.logger import create_small_table
from .evaluator import DatasetEvaluator

try:
    from nora.ops.fast_eval_api import COCOeval_opt
except ImportError:
...
class COCOEvaluator(DatasetEvaluator):
        ...
        *,
        ...
        Args:
            dataset_name (str): name of the dataset to be evaluated.
                ...
                Or it must be in nora's standard dataset format
    ...
    def _eval_predictions(self, predictions, img_ids=None):
        ...
        self._logger.info(f"Evaluating predictions with {'unofficial' if self._use_fast_impl else 'official'} COCO API...")
        ...
        for task in sorted(tasks):
            ...
            ) if len(coco_results) > 0 else None  # cocoapi does not handle empty results very well
    ...
    def _eval_box_proposals(self, predictions):
        ...
        self._logger.info(f"Proposal metrics: \n{create_small_table(res)}")
...
def _evaluate_predictions_on_coco(
    ...
    if iou_type == "keypoints":
        ...
        assert num_keypoints_oks == num_keypoints_dt == num_keypoints_gt, f"Prediction contain {num_keypoints_dt} keypoints. Ground truth contains {num_keypoints_gt} keypoints. The length of keypoint_oks_sigmas is {num_keypoints_oks}. They have to agree with each other."
