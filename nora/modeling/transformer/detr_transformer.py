...
class DETRTransformer(nn.Module):
    ...
    def forward(self, features, mask, query_embed, pos_embed):
        ...
        pos_embed = pos_embed.view(N, C, -1).permute(2, 0, 1)
        query_embed = query_embed.unsqueeze(1).repeat(1, N, 1)  # [num_query, dim] -> [num_query, N, dim]
        ...
        memory = memory.permute(1, 2, 0).reshape(N, C, H, W)
