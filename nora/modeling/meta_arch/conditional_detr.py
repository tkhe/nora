...
__all__ = ["ConditionalDETR"]


class ConditionalDETR(Detector):
    """
    support ConditionalDETR (https://arxiv.org/abs/2108.06152).
    """
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        ...
        hidden_states, references = self.transformer(features, image_masks, self.query_embed.weight, position_embedding)

        predictions = self.box_head(hidden_states, references)
