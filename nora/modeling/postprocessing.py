...
from nora.structures import ROIMasks
...
def detector_postprocess(
    ...
    if results.has("pred_masks"):
        ...
        results.pred_masks = roi_masks.to_bitmasks(results.pred_boxes, output_height, output_width, mask_threshold).tensor  # TODO return ROIMasks/BitMask object in the future
